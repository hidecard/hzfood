...
<section class="container">
    <div class="row m-5 p-4 shadow p-3 mb-5 bg-body rounded">
        <div class="col-lg-6 text-center">
            <img src="<?php echo e(asset('img/Woman ordering food and paying online.png')); ?>" alt="">
        </div>
        <div class="col-lg-6 text-center">
            <h2><span>Welcome to </span> <span class="text-danger">Hz Food</span></h2>
            <h6>Create your account</h6>
            <form action="<?php echo e(route('user_register')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-start mt-2">
                    ...
                    <input id="email" type="phone" class="form-control m-2" name="phone" placeholder="Enter Your Phone Number">
                </div>
                <div class="text-start mt-2">
                ...
                <div>
                  <input class="btn btn-outline-danger w-50 mt-3" type="submit" value="Register">
                </div>
            </form>
            <hr>
            <h5>or</h5>
            <div class="d-flex justify-content-evenly">
              ...
              <div>
                <a class="text-decoration-none text-danger" href="<?php echo e(route('login')); ?>">Login your account</a>
              </div>
            </div>
         </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\laravel\hz_food_shop\resources\views/frontend/register.blade.php ENDPATH**/ ?>