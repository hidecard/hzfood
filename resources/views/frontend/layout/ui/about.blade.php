   ...
   <section class="container-fluid">
    <div class="row mb-4">
        <div class="col-lg-6 text-center">
            <img id="imgabout" src="{{asset('img/gallery-3.jpg')}}" alt="">
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
              <div class="col-lg-4 mb-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                <img class="mb-2" src="{{asset('img/person_1.jpg')}}" alt="">
              ...
              <div class="col-lg-4 mb-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                <img class="mb-2" src="{{asset('img/person_2.jpg')}}" alt="">
                        <div class="info text-center">
              ...
              <div class="col-lg-4 mb-3 d-flex mb-sm-4 ftco-animate">
                  <div class="staff">
                <img class="mb-2" src="{{asset('img/person_3.jpg')}}" alt="">
                        <div class="info text-center">
